...
SET #ACCTS.MEASURE_FREQUENCY = HH.STATUS
FROM (
SELECT SA.ID, CASE WHEN SP.DESCR LIKE '%HH%' AND SP.DESCR NOT LIKE '%NHH%' THEN 'HH' ELSE 'NHH' END STATUS
FROM
VCRO_SERV_ACCT				SA
INNER JOIN
VCRO_SERVICE_PLAN			SP
...
,RECV.RUN_PERIOD 		"FIN_MONTH"
,ACCTS.CD_BUSE
,ACCTS.MEASURE_FREQUENCY
